...
接口本质上是 **Cloureve** 项目原本就存在的，我方仅仅只是搭建API接口文档

## 基本介绍

**Cdifit** 服务端提供 **RESTful API** 接口，您可以通过这些接口实现对 **Cdifit** 的文件管理、用户管理、系统管理等操作。
...
| 40089 | OAuth Token Scope Insufficient            |
| 40090 | Disabled in Demo Mode                     |
